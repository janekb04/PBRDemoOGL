...
{
    float               OffsetNorm;         // Column init offset, normalized 0.0 (far left) -> 1.0 (far right)
...
struct IMGUI_API ImGuiWindowTempData
{
    ...
    ImVec1                  Indent;                 // Indentation / init position from left of window (increased by TreePush/TreePop, etc.)
    ...
    int                     FocusCounterRegular;    // (Legacy Focus/Tabbing system) Sequential counter, init at -1 and increase as assigned via FocusableItemRegister() (FIXME-NAV: Needs redesign)
